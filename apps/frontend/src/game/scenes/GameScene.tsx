  ...
  return (
    ...
    >
      ...
      {/* Estado del sistema, abajo. Comparte banda con el aviso de controles y el botón de
          práctica, que también van centrados al pie; quien se aparta es el pie, que sube
          mientras la mira está puesta (ver el pie de Game.tsx). Se probó a colgarlo de la
          retícula y no vale: la retícula se mide en vmin, así que en una ventana apaisada
          baja justo a la banda del pie. */}

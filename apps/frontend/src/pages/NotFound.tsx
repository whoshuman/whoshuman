...
function NotFound() {
  ...
  return (
    <main className="relative flex min-h-[calc(100vh-4rem)] flex-col items-center justify-center overflow-hidden px-4 py-10 text-center">
      ...
      <div className="animate-unfold-down origin-top relative w-full max-w-lg border border-error/50 bg-surface px-6 py-12 shadow-[0_0_48px_rgba(255,59,107,0.2),inset_0_0_48px_rgba(255,59,107,0.03)] sm:px-16">
        {/* Cabecera terminal */}
        ...
        <div className="mt-8">
          ...
          <h1 className="font-display text-[clamp(4.5rem,20vw,9rem)] font-black leading-none text-error [text-shadow:0_0_28px_rgba(255,59,107,0.7),0_0_56px_rgba(255,59,107,0.35)]">
            404
          </h1>
          ...
          >
            ...
            <span className="hidden sm:inline">{t("notFound.back")}</span> →
          </Link>
        </div>
      </div>
    </main>

    ...
    <main className="main-container">
      <section className="content-section max-w-3xl">
        ...
        <p className="text-xl text-text-muted">
          Selecciona una operación activa o solicita despliegue automático.
        </p>
      </section>
          ...
          <div className="col-span-1 flex flex-col gap-4">
            ...
            <div className="animate-crt-on [transform-origin:center] relative border border-neon-cyan bg-surface p-6 shadow-[0_0_24px_rgba(36,245,255,0.16)]">
              ...
              <div className="grid grid-cols-2 gap-3 border-t border-neon-cyan/15 pt-4 text-sm">
                <div>
                  <p className="text-xs uppercase tracking-wider text-text-muted">Operaciones</p>
                  <p className="font-display font-bold text-text-main">—</p>
                </div>
                <div>
                  <p className="text-xs uppercase tracking-wider text-text-muted">Neutraliz.</p>
                  <p className="font-display font-bold text-text-main">—</p>
                </div>
              </div>
            </div>
            ...
            >
              ...
              <p className="mb-5 text-sm text-text-muted">
                El sistema te asignará una operación y un rol de forma automática.
              </p>
              <button
                type="button"
          ...
          <div className="col-span-2">
            ...
            >
              ...
              <div className="flex flex-col gap-3">
                {[
                  { id: "OP-001", units: "3/6", status: "RECLUTANDO", time: "00:42" },
                  { id: "OP-002", units: "6/6", status: "EN CURSO", time: "01:23" },
                  { id: "OP-003", units: "2/6", status: "RECLUTANDO", time: "00:08" }
                ].map((op) => (
                  <div
                    key={op.id}
                  ...
                  >
                    <div className="flex items-center gap-6">
                      ...
                      <span className="text-sm text-text-muted">{op.units} unidades</span>
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      >
                        <span
                          className={`h-1.5 w-1.5 ${op.status === "RECLUTANDO" ? "animate-pulse" : ""} bg-current`}
                        />
                        {op.status}
                      </span>
                      {op.status === "RECLUTANDO" && (
                        <button
                          type="button"

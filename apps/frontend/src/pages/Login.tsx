  ...
  return (
    ...
    >
      ...
      <div className="animate-unfold-down origin-top relative w-full max-w-md border border-neon-magenta/50 bg-surface shadow-[0_0_48px_rgba(255,43,214,0.2),inset_0_0_48px_rgba(255,43,214,0.03)]">
        {/* Cabecera del panel */}
        <div className="flex items-center justify-between border-b border-neon-magenta/30 bg-neon-magenta/10 px-5 py-4 sm:px-8">
        ...
        <div className="p-5 sm:p-8">
          ...
          <h1 className="font-display mb-1 text-[clamp(2.25rem,7vw,3rem)] font-black leading-none text-text-main [text-shadow:0_0_28px_rgba(255,43,214,0.65),0_0_56px_rgba(36,245,255,0.28)]">
            {t("login.title")}
          </h1>

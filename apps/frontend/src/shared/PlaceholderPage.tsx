  ...
  return (
    <main className="relative flex min-h-[calc(100vh-4rem)] flex-col items-center justify-center overflow-hidden text-center">
      ...
      <div className="animate-unfold-down origin-top relative border border-neon-cyan/50 bg-surface px-16 py-12 shadow-[0_0_48px_rgba(36,245,255,0.18),inset_0_0_48px_rgba(36,245,255,0.03)]">
        ...
        <div className="mt-8">
          <h1 className="font-display mb-4 text-5xl font-black uppercase leading-none text-text-main [text-shadow:0_0_28px_rgba(36,245,255,0.55),0_0_56px_rgba(255,43,214,0.2)]">
            {t(titleKey)}
          </h1>
